(() => {
  ...
  style.textContent = `.yel-cookie{position:fixed;inset:0;z-index:9999;display:grid;grid-template-columns:minmax(0,1fr);place-items:end end;padding:16px;pointer-events:none;font:600 12px/1.45 ui-monospace,SFMono-Regular,Menlo,monospace}.yel-cookie[hidden]{display:none}.yel-cookie__box{box-sizing:border-box;width:min(540px,100%);min-width:0;max-width:100%;padding:14px;border:1px solid rgba(255,255,255,.42);border-radius:16px;background:rgba(14,14,14,.94);color:#f4f4ef;box-shadow:0 16px 42px rgba(0,0,0,.34);backdrop-filter:blur(10px);pointer-events:auto}.yel-cookie h2{margin:0 0 6px;font-size:16px;max-width:none;letter-spacing:-.02em;color:#f4f4ef}.yel-cookie p{margin:0 0 12px;color:rgba(244,244,239,.72)}.yel-cookie__actions{display:flex;gap:5px;flex-wrap:wrap}.yel-cookie button{min-height:38px;padding:0 12px;border:1px solid rgba(255,255,255,.36);border-radius:9px;background:transparent;color:inherit;cursor:pointer;font:inherit}.yel-cookie button[data-primary]{border-color:var(--ds-orange,#ff6422);background:var(--ds-orange,#ff6422);color:#101010}.yel-cookie__settings{padding:8px 0}.yel-cookie label{display:flex;justify-content:space-between;gap:20px;padding:9px 0;border-top:1px solid rgba(255,255,255,.2)}.yel-cookie a{color:inherit;text-underline-offset:3px}@media(max-width:620px){.yel-cookie{place-items:end center}.yel-cookie__box{width:100%;padding:12px}.yel-cookie__actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.yel-cookie button{width:100%;min-width:0}.yel-cookie button[data-settings]{grid-column:1/-1}}`;
