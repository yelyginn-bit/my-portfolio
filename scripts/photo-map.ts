...
/** Бэкстейдж прямой трансляции автофестиваля лежит НЕ внутри архива, а
 * соседней папкой на рабочем столе. Путь задан относительно корня архива
...
export const SINGLE_PHOTOS: readonly SinglePhotoSource[] = [
  ...
  // Порядок = порядок кадров на странице. Приоритет отбора: техника в работе.
  ...sequential(BROADCAST_DIR, "broadcast", [
    "DSC_7063.png", // камера на видеоголове, рука оператора, метка CAM_B, стадион за спиной
    "DSC_7068.png", // монитор и видеомикшер на рэковой стойке, крупно
    "DSC_7089.png", // человек у стойки мониторов: экраны, таймлайн, микшерный рэк
    "DSC_7045.png", // режиссёр за пультом в профиль, в работе
    "DSC_7151.png", // оператор у камеры, интерком-гарнитура, глаз у видоискателя
    "DSC_7176.png", // оператор у камеры на штативе, фасад стадиона «Нижний Новгород» во весь фон
    "DSC_7341.png", // портрет члена команды в интерком-гарнитуре
    "DSC_7013.png", // шоу-кар у фасада стадиона — что снимал эфир
    "DSC_7062.png", // передача интерком-гарнитуры между двумя членами команды
  ]),
];
